...
<head>
  ...
  <title>Celestial Chronometry & Haute Horology — Repeaterhour</title>
  <meta name="description" content="Handcrafted acoustic minute repeaters, cathedral chime gongs, centrifugal strike governors, and hand-chamfered calibres engineered at 181 Mercer Street.">
  <link rel="canonical" href="https://repeaterhour.com/">
...
<body>
  ...
  <div class="announcement-bar" style="background: #080B10; color: #FAF8F5; border-bottom: 1px solid rgba(212, 175, 55, 0.3);">
    <span>&#9672; HAUTE HORLOGERIE &bull; ACOUSTIC MINUTE REPEATERS &bull; GRAND SONNERIE &bull; SALON AT 181 MERCER STREET &bull; TEL: +1-888-777-5845 &bull; CONCIERGE@REPEATERHOUR.COM</span>
  </div>
  <!-- Mandatory Global Site Header (Exactly 1 per page) -->
  <header class="site-header">
    <div class="header-container">
      <a href="/" class="brand-logo" aria-label="Repeaterhour Home">
        <span class="logo-mark">◈</span>
        <span class="logo-text">Repeaterhour</span>
      </a>
  ...
  <div class="mobile-drawer" id="mobile-drawer" aria-hidden="true">
    <div class="drawer-header">
      <div class="drawer-brand">Repeaterhour</div>
    ...
    <nav class="drawer-nav" aria-label="Mobile Navigation">
      ...
      <a href="/collection.html" class="drawer-link">Horological Acoustic Calibre Collection</a>
    ...
    <div class="drawer-footer">
      ...
      <p class="drawer-contact-info">Email: concierge@repeaterhour.com</p>
    </div>
  </div>
  ...
  <section class="page-hero" style="padding: 7rem 1.5rem 6rem; position: relative; overflow: hidden;">
    <div class="container">
      <div style="display: grid; grid-template-columns: 1.15fr 1fr; gap: 4rem; align-items: center;">
        <div>
          <span class="hero-badge">Acoustic Horology &bull; Minute Repeater Calibres</span>
          <h1 style="margin-bottom: 1.4rem; letter-spacing: -0.01em; font-size: clamp(2.4rem, 5vw, 4rem);">Acoustic Minute Repeaters &amp; Haute Horology</h1>
          <p class="lead" style="margin-bottom: 2rem; font-size: 1.18rem; line-height: 1.75;">Handcrafted acoustic minute repeaters, cathedral chime gongs, centrifugal strike governors, and hand-chamfered calibres engineered at 181 Mercer Street.</p>
          ...
          <div style="display: flex; gap: 1.2rem; flex-wrap: wrap;">
            <a href="/collection.html" class="btn btn-gold">Explore Acoustic Vitrine</a>
        ...
        <div style="position: relative;">
          <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 2px solid rgba(212, 175, 55, 0.6);">
            <img src="/assets/images/hero_luxury_tourbillon_watch.jpg" alt="Repeaterhour flagship chronometer" style="width: 100%; height: auto;">
          </div>
    ...
    <div class="container">
      <div class="grid-2">
        ...
        <div style="order: 2; border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 1px solid var(--color-border);">
          <img src="/assets/images/collection_tourbillon_perpetual.jpg" alt="Brass astrolabe and celestial navigation dial">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      <div class="section-header text-center">
        ...
        <h2>Four Architectural Pillars of Repeaterhour</h2>
      ...
      <div class="grid-4">
        <div class="pillar-card">
          ...
          <h3>Cathedral Gong Acoustics</h3>
          <p>Hand-drawn hardened steel gongs coiled twice around the calibre perimeter for crystalline harmonic resonance and sustain.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>Centrifugal Strike Governor</h3>
          <p>Silent micro-inertia governor regulating chime strike tempo with frictionless aerodynamic braking down to 18 milliseconds.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>All-or-Nothing Safety Rack</h3>
          <p>Patented dual-rack mechanical disconnect preventing partial chime sequence actuation or gear-train jam during strike cycles.</p>
        </div>
        <div class="pillar-card">
          <div class="pillar-icon">◈</div>
          <h3>Silicon Free-Sprung Balance</h3>
          <p>Variable inertia balance wheel beating at 28,800 vibrations per hour delivering COSC chronometric accuracy alongside chime torque.</p>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="grid-3">
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/collection_regulator_dress_watch.jpg" alt="Collection Regulator Dress Watch">
            <span class="card-tag">Astronavigation Reserve</span>
          </div>
          <div class="card-body">
            <h3>Collection Regulator Dress Watch</h3>
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/craft_anglage_hand_beveling.jpg" alt="Craft Anglage Hand Beveling">
            <span class="card-tag">Gravitational Tourbillon</span>
          </div>
          <div class="card-body">
            <h3>Craft Anglage Hand Beveling</h3>
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/craft_guilloche_dial_engraving.jpg" alt="Craft Guilloche Dial Engraving">
            <span class="card-tag">Grand Feu Enamel</span>
          </div>
          <div class="card-body">
            <h3>Craft Guilloche Dial Engraving</h3>
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/movement_balance_wheel_hairspring.jpg" alt="Movement Balance Wheel Hairspring">
            <span class="card-tag">Master Atelier Edition</span>
          </div>
          <div class="card-body">
            <h3>Movement Balance Wheel Hairspring</h3>
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/movement_column_wheel_actuator.jpg" alt="Movement Column Wheel Actuator">
            <span class="card-tag">Automatic Skeleton</span>
          </div>
          <div class="card-body">
            <h3>Movement Column Wheel Actuator</h3>
        ...
        <div class="card product-item" data-category="bespoke">
          <div class="card-image-wrap">
            <img src="/assets/images/movement_cotes_de_geneve_bridges.jpg" alt="Movement Cotes De Geneve Bridges">
            <span class="card-tag">Column Wheel Chrono</span>
          </div>
          <div class="card-body">
            <h3>Movement Cotes De Geneve Bridges</h3>
    ...
    <div class="container">
      <div class="grid-2">
        <div>
          ...
          <h2>Acoustic Resonance Metallurgy &amp; Micro-Kinematic Gearing</h2>
          <p>Minute repeaters represent the zenith of classical mechanical complications. Each calibre contains over 400 micro-machined components operating in synchronized acoustic harmony. We forge our sounding cases from acoustically tuned grade 5 titanium and 18k rose gold, optimizing hollowed soundwells to maximize sonic propagation without acoustic damping.</p>
          <p>In our 181 Mercer Street atelier, master horologists tune minute repeater gongs entirely by ear, carefully shaving microscopic fractions of a milligram from each steel wire coil until the low-pitch hour strike and high-pitch minute chime achieve pure musical pitch and cadence.</p>
          <div class="card-specs" style="border: none; margin: 1.5rem 0;">
            <span>◈ <strong>Two-Note Cathedral Gong Chime</strong></span>
            <span>◈ <strong>Silent Centrifugal Governor</strong></span>
            <span>◈ <strong>Grade 5 Acoustic Soundwell Case</strong></span>
          </div>
          <a href="/blog/chronometric-escapement-physics-and-isochronism.html" class="btn btn-outline btn-sm">Read Horological Metallurgy Treatise</a>
        </div>
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 1px solid var(--color-border);">
          <img src="/assets/images/material_grade5_titanium_case.jpg" alt="Horological coaxial escapement and gear train assembly">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section section-light">
    <div class="container">
      <div class="grid-2">
        <div style="border-radius: var(--radius-md); overflow: hidden; box-shadow: var(--shadow-gold); border: 1px solid var(--color-border);">
          <img src="/assets/images/material_rose_gold_metallurgy.jpg" alt="Master watchmaker bench and precision micrometer testing at 181 Mercer Street">
        </div>
        <div>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Repeaterhour Bespoke Standard</th>
    ...
    <div class="container">
      ...
      <div class="grid-4">
        <div class="step-card">
          ...
          <h3>Chime Slide Engagement</h3>
          <p>Engage the repeater slide lever with a smooth, continuous slide to the stop; never release midway to ensure complete rack indexing.</p>
        </div>
        <div class="step-card">
          <div class="step-number">02</div>
          <h3>No Hands Adjustment During Chime</h3>
          <p>Never advance or adjust the crown time setting while the chiming sequence is sounding to protect strike beak engagement.</p>
        </div>
        <div class="step-card">
          <div class="step-number">03</div>
          <h3>Magnetic &amp; Shock Shielding</h3>
          <p>Keep mechanical acoustic calibres away from strong electromagnetic fields and avoid high-impact sports while wearing.</p>
        </div>
        <div class="step-card">
          <div class="step-number">04</div>
          <h3>Atelier Sonic Relubrication</h3>
          <p>Return timepieces to 181 Mercer Street every four years for ultrasonic cleaning, chime tempo calibration, and escapement servicing.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section">
    <div class="container">
      ...
      <div class="grid-3">
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/hero_luxury_tourbillon_watch.jpg" alt="Material Provenance Treatise">
          ...
          <div class="card-body">
            ...
            <a href="/blog/chronometric-escapement-physics-and-isochronism.html" class="btn btn-outline btn-sm">Read Full Treatise</a>
          </div>
        </div>
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/collection_tourbillon_perpetual.jpg" alt="Micro-Engineering Tolerances Treatise">
          ...
          <div class="card-body">
            ...
            <a href="/blog/grand-feu-enamel-dial-pyrometry-and-metallurgy.html" class="btn btn-outline btn-sm">Read Full Treatise</a>
          </div>
        </div>
        <div class="card">
          <div class="card-image-wrap">
            <img src="/assets/images/collection_regulator_dress_watch.jpg" alt="Biomechanical Ergonomics Treatise">
          ...
          <div class="card-body">
            ...
            <a href="/blog/column-wheel-chronograph-calibre-architecture.html" class="btn btn-outline btn-sm">Read Full Treatise</a>
          </div>
        </div>
      </div>
  ...
  <section class="section section-light">
    <div class="container">
      <div class="section-header text-center">
        ...
        <p class="text-muted" style="max-width: 650px; margin: 0.8rem auto 0;">
          Reflections from international collectors, horologists, and long-standing patrons of Repeaterhour.
        </p>
      </div>
      <div class="grid-3">
    ...
    <div class="container">
      <div class="contact-grid">
        <div class="contact-info-card">
          ...
          <div class="contact-detail-row">
            <span class="contact-icon">◈</span>
            <div><strong>Concierge Dispatch:</strong><br>concierge@repeaterhour.com</div>
          </div>
          <div class="contact-detail-row">
            <span class="contact-icon">◈</span>
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <div class="footer-brand">◈ Repeaterhour</div>
          <p class="footer-desc">
            The benchmark of acoustic minute repeaters &amp; haute horology calibres. Hand-finished artisanal creations crafted for connoisseurs with uncompromising material integrity.
          </p>
          ...
          <div class="footer-contact-item"><strong>Concierge:</strong> concierge@repeaterhour.com</div>
        </div>
        <div class="footer-col">
        ...
        <div class="footer-col">
          <ul class="footer-links">
            <li><a href="/blog/chronometric-escapement-physics-and-isochronism.html">Chronometric Escapement Ph</a></li>
            <li><a href="/blog/grand-feu-enamel-dial-pyrometry-and-metallurgy.html">Grand Feu Enamel Dial Pyro</a></li>
            <li><a href="/blog/column-wheel-chronograph-calibre-architecture.html">Column-Wheel Chronograph A</a></li>
            <li><a href="/blog/perpetual-calendar-geartrains-and-astronomical-cams.html">Perpetual Calendar Geartra</a></li>
            <li><a href="/blog/high-frequency-silicon-regulating-organs.html">High-Frequency Silicon Reg</a></li>
            <li><a href="/blog/haute-horlogerie-hand-finishing-and-anglage.html">Haute Horlogerie Hand-Fini</a></li>
          </ul>
        </div>
        <div class="footer-col">
      ...
      <div class="footer-bottom">
        <p>&copy; 2026 Repeaterhour Atelier. All Rights Reserved. Handcrafted at 181 Mercer Street, New York, NY 10012, United States.</p>
